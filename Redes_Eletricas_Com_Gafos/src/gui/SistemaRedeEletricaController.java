...
public class SistemaRedeEletricaController {
    ...
    private void criarNo(double x, double y) {
        ...
        VBox vbox = new VBox(nome,numPessoas, nomeDepartamento, pessoasDepartamento, okButton);
    ...
    public void removerAresta() {
        ...
        VBox vbox = new VBox(origem,destino, origemNo, destinoNo, okButton);
        Scene dialogScene = new Scene(vbox, 400, 300);
        no.setScene(dialogScene);
    ...
    public void adicionarAresta() {
        ...
        Label origem = new Label("índice do departamento de origem: ");
        TextField origemAresta = new TextField();
        Label destino = new Label("Índice do departamento de destino: ");
        TextField destinoAresta = new TextField();
        Label distancia = new Label("Distância entre os departamentos: ");
        ...
        okButton.setOnAction(e -> {       	
        	try {
                ...
                if (grafo.existeAresta(indiceOrigem, indiceDestino)) {
        			throw new OperacaoInvalidaException("Aresta já existente.");
        		}
        ...
        VBox vbox = new VBox(origem,destino, distancia, origemAresta, destinoAresta, pesoAresta, okButton);
        Scene dialogScene = new Scene(vbox, 400, 300);
        no.setScene(dialogScene);
